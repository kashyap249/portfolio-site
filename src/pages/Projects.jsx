...
const PROJECTS = [
  ...
  { num:'04', icon:'📚', title:'RR Home Tuition', url:'https://rrhometuition.netlify.app', desc:'A feature-rich tuition academy site built with React and Firebase. Live student reviews via Firestore, image uploads, teacher-gated achievements section, and dark mode.', client:'Tuition Academy – Jamshedpur', launched:'2026', stack:'React · Firebase · Vite', features:['React + Firebase','Live Reviews','Dark Mode','Image Uploads'] },
];
